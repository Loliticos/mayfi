  ...
  async run ({ author, t, channel, guild, language }, _user) {
    ...
    try {
      ...
      embed
        ...
        .addField(t(`commands:${this.path}.globalRaking`), t(`commands:${this.path}.globalRanking`, { rank: user.pp_rank }))
        .addField(t(`commands:${this.path}.hitAccuracy`), Math.floor(userData.accuracy))
